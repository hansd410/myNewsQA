# V2 : one context, one query, multi answers
...
#        contextSen = nltk.sent_tokenize(story_text.decode('utf-8'))
        ...
        ##### print to JSON #####            
                jsonParagraph=[{"context":contextSen[j],"qas":[{"answers":jsonAnswers,"question":questions,"id":story_id+str(docIdDic[story_id])}]}]
            else:
                continue
            try:
